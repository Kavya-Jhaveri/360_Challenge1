...
gay(oung) — 04/02/2024 2:33 PM
KJ1123 — 04/02/2024 2:34 PM
import math
...
message.txt
9 KB
CAN U SEND ME TJHE TEST FILE AND THE OTHER PYTHON FILE
KJ1123 — Yesterday at 11:01 PM
import math
...
YawBicopter.py
5 KB
Hey sorry I was at practice, these are both of the files, the test file is not updated for the new yaw we implemented
gay(oung) — Today at 12:10 AM
WE CHILLLIINNNNNNNNN its alr i just wanted to include everything in my repo😋
TYYYYYYY
﻿
gay(oung)
forgorg1111
